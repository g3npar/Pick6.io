...
node api/index.js   # API on port 3001
...
Your IP also has to be added to the RDS security group or the database connection will just time out (see [deployment.md](deployment.md)).
